...
function getRatingDelta(playerRating, opponentRating, result, kFactor = DEFAULT_K_FACTOR) {
...
function buildRatedMatchOutcome(playerRating, opponentRating, result, kFactor = DEFAULT_K_FACTOR) {
  const playerDelta = getRatingDelta(playerRating, opponentRating, result, kFactor);
