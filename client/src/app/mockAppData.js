...
export const BOT_PROFILES = [
  ...
  },
  {
    ...
    profilePicture: '/assets/profile-picture-placeholder.png',
    matchHistory: [],
    ratingHistory: buildSeededRatingHistory('bot-yalim', 1080),
    isBot: true,
  },
  {
    id: 'bot-sel',
    ...
    profilePicture: '/assets/profile-picture-placeholder.png',
    matchHistory: [],
    ratingHistory: buildSeededRatingHistory('bot-sel', 1160),
    isBot: true,
  },
  {
    id: 'bot-kor',
    ...
    profilePicture: '/assets/profile-picture-placeholder.png',
    matchHistory: [],
    ratingHistory: buildSeededRatingHistory('bot-kor', 1280),
    isBot: true,
  },
  {
    id: 'bot-doru',
    ...
    profilePicture: '/assets/profile-picture-placeholder.png',
    matchHistory: [],
    ratingHistory: buildSeededRatingHistory('bot-doru', 1360),
    isBot: true,
  },
  {
    id: 'bot-poyraz',
    ...
    profilePicture: '/assets/profile-picture-placeholder.png',
    matchHistory: [],
    ratingHistory: buildSeededRatingHistory('bot-poyraz', 1500),
    isBot: true,
  },
]
